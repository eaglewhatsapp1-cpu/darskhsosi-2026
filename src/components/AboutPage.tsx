...
const AboutPage: React.FC<AboutPageProps> = ({ language }) => {
    ...
    const features = [
        ...
        { icon: BookOpen, color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-100 dark:bg-emerald-900/30', ar: 'تبسيط المفاهIM', arDesc: 'اشرح لي كأنني في الخامسة — تبسيط المفاهيم الصعبة إلى كلمات سهلة وأمثلة قريبة.', en: 'Simplify Concepts', enDesc: 'Explain Like I\'m 5 — breaks down complex ideas into easy words and relatable examples.' },
