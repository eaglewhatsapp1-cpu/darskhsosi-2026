...
const AppHeader: React.FC<AppHeaderProps> = ({ profile, language, onSubjectChange }) => {
  ...
  const getEducationLevelText = () => {
    const levels: Record<string, { ar: string; en: string }> = {
      ...
      middle: { ar: 'متوسط', en: 'Middle School' },
      high: { ar: 'ثانوي', en: 'High School' },
      university: { ar: 'جامعي', en: 'University' },
      professional: { ar: 'متخصص', en: 'Professional' },
    };
  ...
  return (
    <header 
      className="w-full border-b bg-card/95 backdrop-blur-sm sticky top-0 z-50 shadow-sm"
      style={{ 
    ...
    >
      <div className="flex items-center justify-between px-4 py-3 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Avatar className="w-10 h-10 border-2" style={{ borderColor: subjectTheme.primary }}>
